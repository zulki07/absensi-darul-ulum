<x-guest-layout>
    ...
    <x-slot name="logo">
        <div class="text-center mt-4">
            ...
            <p class="text-emerald-200 text-sm mt-1">Sistem Informasi Absensi Santri</p>
        </div>
    </x-slot>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label for="email" value="Email Ustadz" />
